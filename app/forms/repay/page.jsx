...
import { handle_repay } from "@/constant/executeContractFunctions";
...
const RepayForm = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const result = await handle_repay(signerData.signer, signerData?.client, leverage_contract_address, amount);
            if (result) {
                console.log(result);
